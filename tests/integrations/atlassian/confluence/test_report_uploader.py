...
@patch('integrations.atlassian.confluence.report_uploader.AtlassianClient')
def test_upload_report_success(mock_atlassian_client, mock_confluence):
    # Set up the mock for AtlassianClient authentication
    mock_atlassian_client_instance = MagicMock()
    mock_atlassian_client.return_value = mock_atlassian_client_instance
    mock_atlassian_client_instance.authenticate.return_value = True
    ...
    mock_atlassian_client_instance.authenticate.assert_called_once()
    
    # Modify the assertion to handle the case where the method might be called multiple times
...
@patch('integrations.atlassian.confluence.report_uploader.Confluence')
@patch('integrations.atlassian.confluence.report_uploader.AtlassianClient')
def test_upload_report_authentication_failure(mock_atlassian_client, mock_confluence):
    # Set up the mock for AtlassianClient authentication
    mock_atlassian_client_instance = MagicMock()
    mock_atlassian_client.return_value = mock_atlassian_client_instance
    mock_atlassian_client_instance.authenticate.return_value = False  # Simulate authentication failure
