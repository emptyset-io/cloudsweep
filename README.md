...
You can view an example of the generated report [here](https://emptyset-io.github.io/cloudsweep/examples/example_scan_report.html). The report contains metadata on each resource, including why it was flagged as unused.
...
```
git clone https://github.com/emptyset-io/cloudsweep.git
cd cloudsweep
```
...
Make sure your AWS credentials are configured for the accounts you intend to scan.

## How to Use Cloud Sweep

Cloud Sweep scans AWS resources across multiple accounts and regions. Use the command-line arguments to customize your scan settings.
...
```
python main.py --all-regions --organization-role <organization_role> --runner-role <runner_role>
```
...
For full proprietary use, premium features, or additional support, contact us at **[support@emptyset.io](mailto:support@emptyset.io)** for commercial licensing options.
